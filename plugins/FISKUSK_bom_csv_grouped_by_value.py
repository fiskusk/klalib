...
columns = ['ID', 'Qty', 'Designator(s)', 'Value', 'Package (Footprint)', 'Datasheet'] + sorted(list(columnset))
...
for group in grouped:
    ...
    row.append( net.getOnlyFootprint(group) )
    #row.append( net.getGroupFootprint(group) )
    row.append( net.getGroupDatasheet(group) )

    # from column 6 upwards, use the fieldnames to grab the data
